...
Since this was meant to be a small part of the product, I decided not to overengineer it.
You may notice that I used a limited form of clean architecture, with only a repository layer.
